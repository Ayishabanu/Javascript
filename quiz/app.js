var questions = [
    {
        question: 'What is the name of prophet(pbuh)?',
        choices: ['Mohammed', 'Rasol', 'Nabi', 'All'],
        correctAnswer: 3
    },
    {
        question: 'One of the pillars of Islam?',
        choices: ['Love', 'Sleep', 'Prayer', 'Dance'],
        correctAnswer: 2
    },
    {
        question: 'Where the kaba Located?',
        choices: ['Makkah', 'Medina', 'Dubai', 'Pakisthan'],
        correctAnswer: 0
    },
    {
        question: 'Can Muslims celebrate Non-Muslim Festivals?',
        choices: ['Yes', 'No', 'Not sure', 'It is our wish'],
        correctAnswer: 1
    },
    {
        question: 'How many Questions will ask in the grave?',
